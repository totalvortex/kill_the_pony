var panel = { // clase para el personaje
	...
	render : function() {
					ctx.drawImage(chapa , 0 , 0 ,
											chapa.width  , chapa.height ,
											this.casx +19 , this.casy + canvas.height - chapa.height -120,
											chapa.width , chapa.height);
					ctx.save();
					ctx.scale(-1.0, 1.0);
					
					ctx.putImageData(this.vida,this.casx +19 , this.casy + canvas.height - chapa.height -100);


					ctx.drawImage(this.img , 0 , 0 ,
											this.img.width  , this.img.height ,
											-this.casx - this.img.width, this.casy + canvas.height - this.img.height,
											this.img.width , this.img.height);
					ctx.restore();
					...
					ctx.fillText(this.nombre, this.casx +40 , this.casy + canvas.height - chapa.height -103);

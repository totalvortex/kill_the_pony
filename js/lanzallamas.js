function llama(x,y,sprt,avance,distanciamax,angulo){
	...
	this.casx=x+(-32+32*Math.sin(angulo));
...
this.render=function(){
	if(this.activo){
		//alert("("+this.spx+","+this.spy+")");
		ctx.drawImage(this.img,this.spx*ancho,this.spy*ancho,this.anchospr,this.anchospr,this.casx,this.casy,ancho,ancho);
	}
}
